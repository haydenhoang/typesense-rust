...
pub async fn create_key(configuration: &mut configuration::Configuration, api_key_schema: Option<models::ApiKeySchema>) -> Result<models::ApiKey, Error<CreateKeyError>> {
...
pub async fn delete_key(configuration: &mut configuration::Configuration, key_id: i64) -> Result<models::ApiKeyDeleteResponse, Error<DeleteKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_key(configuration: &mut configuration::Configuration, key_id: i64) -> Result<models::ApiKey, Error<GetKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_keys(configuration: &mut configuration::Configuration, ) -> Result<models::ApiKeysResponse, Error<GetKeysError>> {
    let local_var_configuration = configuration;
