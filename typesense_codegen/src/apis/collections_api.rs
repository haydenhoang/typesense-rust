...
pub async fn create_collection(configuration: &mut configuration::Configuration, collection_schema: models::CollectionSchema) -> Result<models::CollectionResponse, Error<CreateCollectionError>> {
...
pub async fn delete_alias(configuration: &mut configuration::Configuration, alias_name: &str) -> Result<models::CollectionAlias, Error<DeleteAliasError>> {
    let local_var_configuration = configuration;

    let local_var_client = &mut local_var_configuration.client;

    let local_var_uri_str = format!("{}/aliases/{aliasName}", local_var_configuration.base_path, aliasName=crate::apis::urlencode(alias_name));
...
pub async fn delete_collection(configuration: &mut configuration::Configuration, collection_name: &str) -> Result<models::CollectionResponse, Error<DeleteCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_alias(configuration: &mut configuration::Configuration, alias_name: &str) -> Result<models::CollectionAlias, Error<GetAliasError>> {
    let local_var_configuration = configuration;
...
pub async fn get_aliases(configuration: &mut configuration::Configuration, ) -> Result<models::CollectionAliasesResponse, Error<GetAliasesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection(configuration: &mut configuration::Configuration, collection_name: &str) -> Result<models::CollectionResponse, Error<GetCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collections(configuration: &mut configuration::Configuration, ) -> Result<Vec<models::CollectionResponse>, Error<GetCollectionsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_collection(configuration: &mut configuration::Configuration, collection_name: &str, collection_update_schema: models::CollectionUpdateSchema) -> Result<models::CollectionUpdateSchema, Error<UpdateCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn upsert_alias(configuration: &mut configuration::Configuration, alias_name: &str, collection_alias_schema: Option<models::CollectionAliasSchema>) -> Result<models::CollectionAlias, Error<UpsertAliasError>> {
    let local_var_configuration = configuration;
