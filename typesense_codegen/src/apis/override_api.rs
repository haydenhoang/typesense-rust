...
/// struct for typed errors of method [`get_search_override_0`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSearchOverride0Error {
    UnknownValue(serde_json::Value),
}


/// Retrieve the details of a search override, given its id.
pub async fn get_search_override_0(configuration: &mut configuration::Configuration, collection_name: &str, override_id: &str) -> Result<models::SearchOverride, Error<GetSearchOverride0Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSearchOverride0Error> = serde_json::from_str(&local_var_content).ok();
