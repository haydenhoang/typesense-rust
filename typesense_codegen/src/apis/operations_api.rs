...
pub async fn retrieve_api_stats(configuration: &mut configuration::Configuration, ) -> Result<models::ApiStatsResponse, Error<RetrieveApiStatsError>> {
...
pub async fn retrieve_metrics(configuration: &mut configuration::Configuration, ) -> Result<serde_json::Value, Error<RetrieveMetricsError>> {
    let local_var_configuration = configuration;
...
pub async fn take_snapshot(configuration: &mut configuration::Configuration, snapshot_path: &str) -> Result<models::SuccessStatus, Error<TakeSnapshotError>> {
    let local_var_configuration = configuration;
...
pub async fn vote(configuration: &mut configuration::Configuration, ) -> Result<models::SuccessStatus, Error<VoteError>> {
    let local_var_configuration = configuration;
